package com.data.hope.sqlbuilder.parser;

import com.data.hope.sqlbuilder.enums.DateFormatType;
import com.data.hope.sqlbuilder.enums.FunctionType;
import com.data.hope.sqlbuilder.enums.TimeUnitType;
import com.data.hope.sqlbuilder.util.FunCheckUtils;
import com.google.common.collect.ImmutableList;
import com.data.hope.sqlbuilder.dto.SqlField;
import com.data.hope.sqlbuilder.exception.SQLBuildException;
import com.data.hope.sqlbuilder.function.FunctionCheckDefinition;
import com.data.hope.sqlbuilder.model.BinaryCondition;
import com.data.hope.sqlbuilder.model.Case;
import com.data.hope.sqlbuilder.model.CustomSql;
import com.data.hope.sqlbuilder.model.Field;
import com.data.hope.sqlbuilder.model.Function;
import com.data.hope.sqlbuilder.model.InCondition;
import com.data.hope.sqlbuilder.model.Model;
import com.data.hope.sqlbuilder.model.MultipleModel;
import com.data.hope.sqlbuilder.model.Table;
import com.data.hope.sqlbuilder.util.AssertUtils;
import com.data.hope.sqlbuilder.util.EnumUtils;
import com.data.hope.sqlbuilder.util.RegexUtils;
...
public class ExpressionParser {
    ...
    private Model parse(SqlNode sqlNode) {
        if (sqlNode instanceof SqlBasicCall) {
            ...
            //参数
            SqlNode[] operands = operandList.toArray(new SqlNode[operandList.size()]);
