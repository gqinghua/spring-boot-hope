...
//        String perSecond = CronBuilder.builder().seconds(0).minutes(0).hours(1).month(1).build();
//        String perSecond = CronBuilder.builder().seconds(0,5,false).build();

//        String perSecond = CronBuilder.builder()
//                .seconds(0)
//                .minutes(0)
